...
import (
	"database/sql"
	"fmt"
	"Taufik_54419471_pert3/model" //sesuaikan dengan nama folder (case sensitive)
	"testing"
)
...
func init() {
	...
	password = ""
	host = "localhost"
	namaDB = "db_54419471" // Misal : db_13116429
	defaultDB = "mysql"
}
...
/* Function Testing dibawah ini berfungsi untuk menghapus DB (Apab
ila ingin melakukan testing,
silahkan di comment terlebih dahulu. Abaikan apabila telah ter
-comment)
*/
...
Catatan :
1. Baris kode yang dikomentari di bawah ini merupakan baris
Kode untuk melakukan pembuatan tabel Matkul dan Nilai
2. Silahkan hilangkan komentar baris kode dibawah
apabila telah membuat model dan test berupa :
- matakuliah.go
- nilai.go
- matakuliah_test.go
- nilai_test.go
